...
export class ClientService{
    ...
    Gets(isShowLoading?: boolean): Observable<any> {
        return this.Loading(this.Http.get<any>(`https://localhost:44330/api/site/getall`, {
          observe: 'response',  
          headers: this.getHeader(),
        }), isShowLoading).pipe(map(r => r.body));
    }
    Post(entity:ClientEntity,isShowLoading?: boolean): Observable<any> {
        return this.Loading(this.Http.post<any>(`https://localhost:44330/api/site/getall`, entity, {
          observe: 'response',  
          headers: this.getHeader(),
        }), isShowLoading).pipe(map(r => r.body));
    }
    Put(entity:ClientEntity,isShowLoading?: boolean): Observable<any> {
        return this.Loading(this.Http.put<any>(`https://localhost:44330/api/site/getall`+`/${entity.client_id}`, entity, {
          observe: 'response',  
          headers: this.getHeader(),
        }), isShowLoading).pipe(map(r => r.body));
    }
    DeleteById(entity:ClientEntity,isShowLoading?: boolean): Observable<any> {
        return this.Loading(this.Http.delete<any>(`https://localhost:44330/api/site/getall`+`/${entity.client_id}`, {
          observe: 'response',  
          headers: this.getHeader(),
        }), isShowLoading).pipe(map(r => r.body));
    }
